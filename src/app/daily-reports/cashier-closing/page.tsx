          ...
          if (res.ok && !cancelled) {
            ...
            if (resData.success) {
              ...
              setPayments(p => ({
                ...
                grossRevenue: liveMode && typeof resData.posGrossRevenue === 'number' ? resData.posGrossRevenue : p.grossRevenue,
                serviceCharge: liveMode && typeof resData.posServiceCharge === 'number' ? resData.posServiceCharge : p.serviceCharge,
                discount: liveMode && typeof resData.posDiscount === 'number' ? resData.posDiscount : p.discount,
                posUnpaid: posUnpaid,
                revenue: liveMode && typeof resData.posTotalSales === 'number' ? resData.posTotalSales : (liveMode && typeof resData.posTotalRevenue === 'number' ? resData.posTotalRevenue : p.revenue),
