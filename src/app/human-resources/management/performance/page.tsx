...
/* ─── Helpers ─── */
const OVERALL_LABELS: Record<number, { label: string; color: string; bg: string }> = {
...
function computePeriodLabel(periodType: string, dateStr: string, offset: number): string {
...
function PerformanceModal({ open, onClose, onSave, review, staffList, allCategories, saving, preselectedStaffId, preselectedPeriod, onDelete }: PerformanceModalProps & { preselectedStaffId?: string | null, preselectedPeriod?: string }) {
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" readOnly disabled value={selectedStaff ? `${selectedStaff.full_name} — ${selectedStaff.position}` : ''}
