...
export default function MonthlyCreditsPage() {
    ...
    function handleExport() {
        const headers = [
            ...
            t.table?.headers?.shift || 'Shift',
            t.table?.headers?.handledBy || 'Handled By',
        ...
        exportToCsv(`credits-${monthInputValue}.csv`, headers, data)
    }
                ...
                <table className="w-full table-auto text-sm text-gray-900">
                    <thead>
                        <tr>
                            ...
                            <Th label={t.table?.headers?.shift || 'Shift'} active={sortKey === 'shift'} asc={sortAsc} onClick={() => toggleSort('shift')} />
                            <Th label={t.table?.headers?.handledBy || 'Handled By'} active={sortKey === 'handledBy'} asc={sortAsc} onClick={() => toggleSort('handledBy')} />
