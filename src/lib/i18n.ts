...
const dict = {
  en: {
    ...
    CompanyName: 'Company/Partner Name *',
    TypeCategory: 'Type Category',
    SelectCategory: 'Select Category...',
    TourOperator: 'Tour Operator',
    Concierge: 'Concierge',
    ...
    TaskTitlePlaceholder: 'Follow up with hotel manager...',
    DueDate: 'Due Date',
    Priority: 'Priority',
    High: 'High',
    Medium: 'Medium',
    ...
    DashboardSelectBranch: 'Select Branch',
    DashboardBranchesLoadFailed: 'Failed to load branches',
    DashboardBranchesEmpty: 'No branches configured.',
  ...
  vi: {
    ...
    CompanyName: 'Tên Công ty/Đối tác *',
    TypeCategory: 'Danh mục loại',
    SelectCategory: 'Chọn Danh mục...',
    TourOperator: 'Nhà điều hành Tour',
    Concierge: 'Lễ tân',
    Corporate: 'Doanh nghiệp',
    ...
    TaskTitlePlaceholder: 'Theo dõi với quản lý khách sạn...',
    ...
    TaskDescPlaceholder: 'Thêm bất kỳ chi tiết phụ nào, liên kết zoom, hoặc ghi chú...',
    ...
    // DASHBOARD
    DashboardReady: 'Bảng điều khiển đã sẵn sàng',
    DashboardSubtitle: 'Trung tâm quản lý các mô-đun của bạn.',
    ...
    DashboardSelectBranch: 'Chọn Chi nhánh',
    DashboardBranchesLoadFailed: 'Không thể tải danh sách chi nhánh',
    DashboardBranchesEmpty: 'Chưa có chi nhánh nào được cấu hình.',

    // MODULES
    System: 'Hệ thống',
    CostingOperations: 'Chi phí & Vận hành',
    DailyReports: 'Báo cáo Hằng ngày',
    ...
    MaterialsHistory: 'Lịch sử Nguyên vật liệu',
    Equipment: 'Thiết bị',
    EquipmentHistory: 'Lịch sử Thiết bị',
